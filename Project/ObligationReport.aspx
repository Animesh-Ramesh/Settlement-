<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ObligationReport.aspx.cs" Inherits="Project.ObligationReport" %>
...
<head runat="server">
    ...
    <title>Custodian : Obligation Report</title>
    <!-- Custom Fonts -->
      ...
      <div class="container">
        ...
        <div class="container">
            ...
            <div class="table-responsive" >
                ...
                <asp:SqlDataSource ID="ObligationReport_ds_C_funds" runat="server" ConnectionString="<%$ ConnectionStrings:CNS_SYSTEMConnectionString %>" SelectCommand="SELECT CustodianName,FundsNetSettle FROM FundObligationRepo Where CustodianName= @user" >
                    <SelectParameters>
                        <asp:SessionParameter Name ="user" SessionField ="CName" ConvertEmptyStringToNull ="True" />
                    </SelectParameters>
                </asp:SqlDataSource>
